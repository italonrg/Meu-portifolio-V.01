...
const Navbar = () => {
  ...
  return <nav className= {`fixed w-full left-0 top-0 z-[999] ${stick ? ':bg-white/60 text-gray-900' : 'text-white'}`}>
    ...
    <div className="flex items-center justify-between">
      ...
      <div className={ ` ${stick ? "bg-white/0 bg-white" : "bg-white"}  text-gray-900 md:block hidden px-7 py-2 font-medium bg-white rounded-bl-full`}>
